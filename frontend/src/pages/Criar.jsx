...
export default function Criar() {
  return (
    <DefaultLayout>
      <ContentContainer>
        <Image source={text} style={{ width: '50%', height: 'auto', marginTop: "19%", marginLeft: "2%" }} />
      </ContentContainer>
      <span><a href="/src/views/menu.ejs"><Image source={arrow} style={{ width: '46px', height: '46px', marginLeft: "1%" }} /></a></span>
      <FormContainer>
        <form>
         
                <P> Dificuldade </P>
                <Inputs type={"radio"} name={"op1"} value={"facil"}></Inputs>
                <Label htmlFor="facil">Fácil</Label><br></br>
                <Inputs type={"radio"} name={"op1"} value={"medio"}></Inputs>
                <Label htmlFor="medio">Médio</Label><br></br>
                <Inputs type={"radio"} name={"op1"} value={"difcil"}></Inputs>
                <Label htmlFor="dificl">Dificil</Label><br></br>
         
                <P> Modo </P>
                <Inputs type={"radio"} name={"op2"} value={"individual"}></Inputs>
                <Label htmlFor="facil">Individual</Label><br></br>
                <Inputs type={"radio"} name={"op2"} value={"equipa"}></Inputs>
                <Label htmlFor="medio">Equipa</Label><br></br>
                <br></br>
